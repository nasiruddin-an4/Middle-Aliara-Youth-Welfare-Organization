...
const ExpenseSchema = new mongoose.Schema(
  {
    ...
    year: { type: Number },
    month: { type: Number },
    numberGiven: { type: Number }, // Legacy: Total number of people/items
    amountPerPerson: { type: Number }, // Legacy: Expense per person
    location: { type: String }, // Where the expense happened
    items: [ExpenseItemSchema], // Invoice line items
  },
  { timestamps: true },
);
